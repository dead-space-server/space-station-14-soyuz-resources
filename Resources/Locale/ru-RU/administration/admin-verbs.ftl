...
admin-verbs-erase-description = Удаляет человека из раунда, манифеста, а также удаляет его сообщения.
    Предметы игрока выпадают на пол.
    Игрокам вокруг показывается поп-аут предупреждающий что они должны играть как будто этого игрока не существовало раньше.
    Не банит игрока и не выкидывает в лобби.
    Используйте против набегеров!
