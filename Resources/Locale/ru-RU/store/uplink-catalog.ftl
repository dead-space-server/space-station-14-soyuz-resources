...
uplink-esword-double-desc = Гораздо более дорогая альтернатива обычному энергетическому мечу: с большим шансом отражения, большим углом атаки, более высоким ущербом по конструкциям и большей скоростью замаха. Сильно шумит при включении и использовании.
...
uplink-shrapnel-grenade-desc = Выпускает серию острых осколков, наносящих огромное количество повреждений по незащищённым целям.
# Ammo
...
uplink-holopara-kit-desc =
    ...
    Страж может наносить быстрые удары, невосприимчив к опасностям атмосферы и устойчив к механическим повреждениям, но разделяет получаемые повреждения с хозяином.
...
uplink-holoclown-kit-desc =
    ...
    Голоклоун имеет карманы, в которых может хранить вещи, руку, которой он может взаимодействовать с миром, невосприимчив к опасностям атмосферы и устойчив к механическим повреждениям, но разделяет получаемые повреждения с хозяином.
