...
traitor-role-greeting =
    Вы — агент вражеской корпорации { $corporation }, выполняющий секретное задание по подрыву деятельности станции.
    Ваши цели и кодовые слова перечислены в меню персонажа.
    Воспользуйтесь аплинком, встроенным в Ваш КПК, чтобы приобрести всё необходимое для успешного выполнения задания.
    Смерть СССП!
