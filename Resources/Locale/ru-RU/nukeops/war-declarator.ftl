...
war-declarator-conditions-left-outpost = Шаттл покинул аванпост "Рассвета"
...
war-declarator-default-message = Пограничный отряд "Рассвета" объявляет о своём намерении уничтожить станцию при помощи ядерного устройства и призывает экипаж предпринять ничтожную попытку остановить их.
