...
comms-console-menu-recall-ert = Отозвать СОБР
comms-console-menu-first-privileged-id-label = ID Карта с доступом Капитана:
comms-console-menu-second-privileged-id-label = ID Карта с доступом НМ:
comms-console-menu-ert-message-placeholder = Причина вызова СОБР...
comms-console-menu-call-ert-status-called = СОБР Вызван
