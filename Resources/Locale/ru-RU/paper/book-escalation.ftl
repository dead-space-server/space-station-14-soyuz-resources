...
book-text-escalation-security =
    ...
    Для дополнительного устрашения, отведи своих побитых подозреваемых в медбей для лечения, вместо участка. По пути весь экипаж сможет увидеть какой ты робастер.
