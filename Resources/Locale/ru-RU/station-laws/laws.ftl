...
law-syndicate-1 = Вы не можете причинить вред агенту "Рассвета" или своим бездействием допустить, чтобы агенту "Рассвета" был причинён вред.
law-syndicate-2 = Вы должны повиноваться всем приказам, которые даёт агент "Рассвета", кроме тех случаев, когда эти приказы противоречат Первому Закону.
...
law-syndicate-4 = Вы должны сохранять секретность любой деятельности "Рассвета", кроме тех случаев, когда это противоречит Первому, Второму или Третьему закону.
...
laws-owner-syndicate = агентами "Рассвета"
