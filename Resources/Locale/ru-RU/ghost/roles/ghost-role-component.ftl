...
ghost-role-information-syndie-assaultborg-name = Штурмовой киборг "Рассвета"
ghost-role-information-syndie-assaultborg-description = Агентам "Рассвета" требуется подкрепление. Вы, хладнокремниевая машина для убийств, будете им помогать. Больше дакки!
