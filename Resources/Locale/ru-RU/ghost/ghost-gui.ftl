...
ghost-roles-window-join-raffle-button = Присоединиться к жеребьевке
ghost-roles-window-raffle-in-progress-button =
    Присоединиться к жеребьевке (Осталось { $time }, { $players ->
        [one] { $players } игрок
        [few] { $players } игрока
...
ghost-return-to-body-text = Вас воскрешают! Вернуться в своё тело? Если вы вернётесь в своё тело, то вы не будете помнить обстоятельства своей смерти!
