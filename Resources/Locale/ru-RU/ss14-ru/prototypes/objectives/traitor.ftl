...
ent-EscapeShuttleObjective = Улетите на Генеральный штаб живым и свободным.
...
ent-KillRandomPersonObjective = { ent-BaseKillObjective }
    .desc = Сделайте это, как посчитаете нужным. Только убедитесь, что цель не улетит на Генеральный штаб.
