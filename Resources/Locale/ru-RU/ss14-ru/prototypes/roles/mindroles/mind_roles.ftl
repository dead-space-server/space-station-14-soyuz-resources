...
ent-MindRoleNinja = Роль космический ниндзя
    .desc = { ent-BaseMindRoleAntag.desc }
ent-MindRoleNukeops = Роль оперативник Легиона
    .desc = { ent-BaseMindRoleAntag.desc }
ent-MindRoleNukeopsMedic = Роль медик оперативников Легиона
    .desc = { ent-MindRoleNukeops.desc }
ent-MindRoleNukeopsCommander = Роль командир оперативников Легиона
    .desc = { ent-MindRoleNukeops.desc }
