...
ent-ClothingNeckLawyerbadge = значок сотрудника юридического департамента
    .desc = Значок, свидетельствующий что владелец является сотрудником пожалуй самого уникального отдела станции СССП.
