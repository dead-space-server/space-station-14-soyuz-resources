...
ent-ClothingOuterCoatDetectiveLoadoutGrey = нуарный тренч
    .desc = Ах, ваш верный тренч. Пара прорех тут и там придают ему более соответствующий детективу вид. По крайней мере, так вы сказали себе, когда узнали, что починка обойдется вам в 200 кредитов.
