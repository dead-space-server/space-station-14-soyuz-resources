...
ent-ClothingOuterCoatDetectiveLoadoutGrey = нуарный тренч
    .desc = Ах, ваш верный тренч. Пара прорех тут и там придают ему более соответствующий следователю вид. По крайней мере, так вы сказали себе, когда узнали, что починка обойдется вам в 200 кредитов.
...
ent-ClothingOuterCoatPirate = одежда пирата
    .desc = Яррр.
ent-ClothingOuterCoatWarden = бронированная куртка участкового
    .desc = Прочная, шахтерская куртка, предназначенная для защиты участкового от любых угроз, связанных с участком.
...
ent-ClothingOuterCoatParamedicWB = ветровка фельдшера
    .desc = Надёжная ветровка фельдшера, которая способна защитить от любого космического ветра.
