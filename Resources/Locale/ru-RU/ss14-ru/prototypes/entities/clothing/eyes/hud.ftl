...
ent-ClothingEyesHudOmni = omni hud
    .desc = Окуляр с индикатором на стекле.
    .suffix = Филлер
ent-ADTClothingEyesHudAdvanced = продвинутый визор
...
ent-ClothingEyesHudSyndicateAgent = визор агента "Рассвета"
    .desc = Профессиональный визор агента "Рассвета", предназначенный для быстрой диагностики состояния команды.
