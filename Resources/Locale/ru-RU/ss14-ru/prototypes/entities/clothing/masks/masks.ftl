...
ent-ClothingMaskGasCaptain = противогаз капитана
    .desc = В USSP решили срезать углы и перекрасить запасной атмос-противогаз, только никому об этом не говорите.
...
ent-ClothingMaskGasDeathSquad = противогаз бойца отряда специального назначения "Дым"
    .desc = Уникальный противогаз самого элитного отряда USSP.
