...
ent-ClothingUniformJumpsuitRepairmanSyndie = комбинезон ремонтника Синдиката
    .desc = Функциональный, модный, крутой. Инженеры USSP мечтают выглядеть так же хорошо, как и вы.
ent-ClothingUniformJumpsuitParamedicNT = комбинезон фельдшера
    .desc = Простой бело-голубой комбинезон, предназначенный для фельдшеров USSP, работающих в боевых секторах.
