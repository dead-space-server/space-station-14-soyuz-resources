...
ent-ClothingHeadHatBeretWarden = берет оперативного дежурного
    .desc = Фирменный голубой берет с эмблемой оперативного дежурного. Для офицеров, которые предпочитают стиль безопасности.
...
ent-ClothingHeadHatBeretBrigmedic = белый берет врача
