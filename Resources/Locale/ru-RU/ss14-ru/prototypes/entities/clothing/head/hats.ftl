...
ent-ClothingHeadHatBeretWarden = берет участкового
    .desc = Фирменный голубой берет с эмблемой участкового. Для милиционеров, которые предпочитают стиль безопасности.
...
ent-ClothingHeadHatCentcom = фирменная шапка Генштаба
...
ent-ClothingHeadHatWarden = фуражка участкового
