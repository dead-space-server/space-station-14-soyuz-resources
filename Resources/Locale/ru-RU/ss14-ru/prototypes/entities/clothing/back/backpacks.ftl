...
ent-ClothingBackpackSeniorSecurity = рюкзак старшего милиционера
    .desc = Это очень робастный рюкзак.
...
ent-ClothingBackpackERTSecurity = рюкзак милиционера СОБР
    .desc = Вместительный рюкзак с множеством карманов, который носят милиционеры специального отряда быстрого реагирования.
