...
ent-PosterLegitNanotrasenLogo = Плакат коммунизма
    .desc = Плакат с изображением серпа и молота.
...
ent-PosterLegitUeNo = Не болтай!
    .desc = Даже стены слушают. Особенно, если это стены НКВБ.
