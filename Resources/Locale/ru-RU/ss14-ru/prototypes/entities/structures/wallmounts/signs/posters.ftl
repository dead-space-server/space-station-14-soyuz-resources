...
ent-PosterContrabandSyndicateRecruitment = Вступайте в Легион
...
ent-PosterContrabandGreyTide = Грейтайд
    .desc = Бунтарский плакат, символизирующий солидарность разнорабочих.
ent-PosterContrabandMissingGloves = Пропавшие перчатки
    .desc = Этот плакат описывает возмущение, возникшее после того, как USSP сократила финансовые расходы на закупку изолирующих перчаток.
ent-PosterContrabandHackingGuide = Руководство по взлому
    .desc = Этот плакат подробно описывает внутреннюю работу стандартных воздушных шлюзов USSP. К сожалению, он устарел.
ent-PosterContrabandRIPBadger = Спите спокойно, барсуки
    .desc = Этот провокационный плакат рассказывает о геноциде, устроенном USSP на космической станции, полной барсуков.
...
ent-PosterContrabandPower = Мощь
    .desc = Плакат, который изображает власть за пределами USSP.
...
ent-PosterContrabandCommunistState = Серп и молот!
    .desc = Плакат с изображением серпа и молота, символикой коммунистистов.
...
ent-PosterContrabandKosmicheskayaStantsiya = Космической станции 13 не существует
    .desc = Плакат, высмеивающий отрицание ГенШтабом существования какой-либо Космической станции 13.
...
ent-PosterContrabandSyndicatePistol = Пистолеты "Рассвета"
    .desc = Плакат, рекламирующий пистолеты "Рассвета" как "чертовски классные". Он покрыт выцветшими тэгами банд.
...
ent-PosterContrabandFreeSyndicateEncryptionKey = Халявный ключ шифрования "Рассвета"
...
ent-PosterContrabandVoteWeh = Серп и молот!
    .desc = Плакат с изображением серпа и молота, символикой коммунистистов.
...
ent-PosterContrabandRevolt = Революция
    .desc = Революционная пропаганда, выпущенная СССП.
ent-PosterContrabandMoth = СиндиНиан - Легионерские операции
    .desc = Плакат, созданный по заказу "Рассвета", с использованием СиндиНиан™, призывающий зрителя держать диск ядерной аутентификации незащищенным. "Мир никогда не был вариантом!" Ни один хороший сотрудник не станет прислушиваться к этой чепухе.
...
ent-PosterContrabandEnlistGorlex = Идёт набор
    .desc = Вступайте в ряды Мародёров ОПЗ уже сегодня! Путешествуйте по галактике, убивайте коммунистов, получайте деньги!
...
ent-PosterLegitLoveIan = Любовь к Ивану
    .desc = Иван - любовь, Иван - это жизнь.
...
ent-PosterLegitSoftCapPopArt = Серп и молот!
    .desc = Плакат с изображением серпа и молота, символикой коммунистистов.
...
ent-PosterLegit50thAnniversaryVintageReprint = Винтажная перепечатка к 50-летнему юбилею
    .desc = Перепечатка плаката 2505 года, посвящённого 50-летию организации Unionposters Manufacturing.
ent-PosterLegitFruitBowl = Миска с фруктами
    .desc = Просто, но впечатляюще.
ent-PosterLegitPDAAd = Реклама КПК
    .desc = Плакат, рекламирующий новейшие КПК от поставщиков USSP.
ent-PosterLegitEnlist = Любовь к Ивану
    .desc = Иван - любовь, Иван - это жизнь.
...
ent-PosterLegitSecWatch = Милиция следит за тобой
