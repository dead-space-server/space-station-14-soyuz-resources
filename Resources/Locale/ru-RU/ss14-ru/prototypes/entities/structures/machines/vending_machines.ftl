...
ent-VendingMachineBoozeSyndicate = АлкоМат
...
ent-VendingMachineSec = МилицТех
    .desc = Торговый автомат с экпипировкой милиции. На табличке написано "ТОЛЬКО ДЛЯ СОТРУДНИКОВ МИЛИЦИИ".
ent-VendingMachineSustenance = тюремный торгомат
    .desc = Торговый автомат, который реализует продукты питания, как того требует раздел 47-C Соглашения об этическом обращении с заключёнными СССП.
...
ent-VendingMachineHydrobe = ГидроРоб
    .desc = Автомат с запоминающимся названием. Он раздаёт одежду и снаряжение, связанные с агрономией.
ent-VendingMachineLawDrobe = ЗаконШкаф
    .desc = Протест! Этот шкаф обеспечивает верховенство закона... и одежду юристам...
...
ent-VendingMachineDetDrobe = СледоШкаф
...
ent-VendingMachineSyndieDrobe = торгомат "Рассвета"
    .desc = Шкаф-машина, закодированная "Рассветом", содержит элитную экипировку для различных операций.
...
ent-VendingMachineCentDrobe = ГенШкаф
...
ent-VendingMachineChemicalsSyndicate = РассветоСоки
    .desc = Надеюсь, не из свежевыжатых агентов?
