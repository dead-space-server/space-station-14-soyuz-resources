...
ent-ComputerShuttle = консоль управления шаттлом
    .desc = Используется для пилотирования корабля.
ent-ComputerShuttleSyndie = консоль управления шаттлом "Рассвета"
    .desc = Используется для пилотирования корабля "Рассвета".
ent-ComputerShuttleCargo = консоль управления грузовым шаттлом
    .desc = Используется для пилотирования грузового шаттла.
ent-ComputerShuttleSalvage = консоль управления шахтерским шаттлом
    .desc = Используется для пилотирования шахтерским шаттла.
...
ent-ComputerCriminalRecords = консоль криминальных записей
    .desc = Её можно использовать для проверки судимостей. Редактировать их могут только милиционеры.
...
ent-ComputerId = консоль ID карт
    .desc = Компьютер для программирования ID карт сотрудников USSP, для доступа к разным частям станции.
...
ent-SyndicateComputerComms = консоль связи "Рассвета"
...
ent-ComputerSalvageExpedition = консоль шахтерских экспедиций
