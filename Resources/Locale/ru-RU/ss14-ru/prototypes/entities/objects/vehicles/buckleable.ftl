...
ent-VehicleSecway = секвей
    .desc = Будущее перемещения. Популяризирован святым Иаковом, покровителем сотрудников  и модераторов интернет-форумов.
ent-VehicleATV = квадроцикл
    .desc = Все-клеточное транспортное средство.
ent-VehicleSyndicateSegway = кроваво-красный сегвей
    .desc = Красный цвет, брутальный узор протекторов, стильные диски... Вы знаете, на чём будете уезжать от ядерного взрыва!
