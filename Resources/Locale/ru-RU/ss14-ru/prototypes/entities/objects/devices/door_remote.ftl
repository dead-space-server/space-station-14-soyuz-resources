...
ent-DoorRemoteSecurity = пульт от шлюзов отдела милиции
    .desc = { ent-DoorRemoteDefault.desc }
ent-DoorRemoteArmory = пульт от шлюзов оружейной
    .desc = { ent-DoorRemoteDefault.desc }
ent-DoorRemoteService = пульт от шлюзов отдела обслуживания
    .desc = { ent-DoorRemoteDefault.desc }
ent-DoorRemoteResearch = пульт от шлюзов научного отдела
    .desc = { ent-DoorRemoteDefault.desc }
ent-DoorRemoteCargo = пульт от шлюзов отдела почты
    .desc = { ent-DoorRemoteDefault.desc }
