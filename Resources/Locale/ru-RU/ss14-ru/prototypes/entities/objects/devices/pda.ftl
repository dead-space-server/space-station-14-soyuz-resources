...
ent-ResearchSurgeonPDA = КПК хирурга
...
ent-SyndiPDA = болотно-зелёный КПК
    .suffix = КПК "Рассвета"
...
ent-BlueShieldOfficerPDA = КПК оперативника КГБ
    .desc = КПК, разработанный специально для оперативников комитета государственной безопасности, в задачи которых входит защита членов руководства коллектива станции. Имеет встроенный анализатор здоровья.
...
ent-SyndiAgentPDA = КПК агента "Рассвета"
    .desc = Когда лечения простых агентов "Рассвета" недостаточно, займитесь лечением Ядерных оперативников!
