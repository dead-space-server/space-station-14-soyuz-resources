...
ent-TrackingImplant = имплант Трекер
    .desc = Этот имплант оснащён устройством слежения, подключенным к сети датчиков комбинезонов, а также монитором состояния для радиоканала .
...
ent-UplinkImplant = имплант Аплинк
    .desc = Этот имплант позволяет владельцу пользоваться спрятанным аплинком "Рассвета".
...
ent-DeathRattleImplant = имплант Предсмертный хрип
    .desc = Этот имплант сообщит в радиоканал "Рассвета", если пользователь окажется в критическом состоянии или умрёт.
