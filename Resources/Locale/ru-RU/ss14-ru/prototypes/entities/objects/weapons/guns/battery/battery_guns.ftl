...
ent-WeaponPulseRifle = импульсная винтовка
    ...
    .suffix = Винтовка, Эскадрон, Нечестный урон
...
ent-WeaponDisabler = станнер
    ...
    .suffix = Пистолет
ent-WeaponDisablerSMG = станнер ПП
...
ent-WeaponTaser = тазер
    .desc = Электрошокер малой мощности, используемый Милицией для подавления целей на расстоянии.
    .suffix = Пистолет
ent-WeaponAntiqueLaser = антикварный лазерный пистолет
    .desc = Вся отделка выполнена на высочайшем уровне. Он украшен кожей разнорабочих и хромом. Предмет устрашает энергетическими всплесками.
    .suffix = Пистолет
...
ent-PistolBlueShield = пистолет оперативника КГБ
    .desc = Пистолет, разработанный специально для оперативников комитета государственной безопасности, в задачи которых входит защита членов руководства коллектива станции.
    .suffix = Пистолет
