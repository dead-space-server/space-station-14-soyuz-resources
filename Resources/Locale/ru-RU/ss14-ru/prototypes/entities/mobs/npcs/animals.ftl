...
ent-MobGlockroach = глок-таракан
    .desc = Эта станция просто кишит насе- О БОЖЕ, У ЭТОГО ТАРАКАНА ПИСТОЛЕТ!!!
...
ent-MobBaseSyndicateMonkey = обезьяна
    .desc = Новая церковь неодарвинистов действительно верит, что КАЖДОЕ животное произошло от обезьяны. На вкус они как свинина, а убивать их весело и приятно.
    .suffix = Рассвет, Синдикат, Базовый
...
ent-MobMonkeySyndicateAgentNukeops = { ent-MobBaseSyndicateMonkey }
    ...
    .desc = { ent-MobBaseSyndicateMonkey.desc }
ent-MobBaseKobold = маккобольд
    .desc = Двоюродные братья кобольдов, маккобольд сливаются с индустриальной плиткой и так же противны, как обезьяны.
ent-MobKobold = маккобольд
    .desc = Двоюродные братья кобольдов, маккобольд сливаются с индустриальной плиткой и так же противны, как обезьяны.
...
ent-MobGrenadePenguin = пингвин гренадёр
    .desc = Маленький пингвин с гранатой на шее. Заготавливаются "Рассветом" на неблагоприятных ледяных планетах.
ent-MobSnake = змея
...
ent-MobCatSyndy = котик "Рассвета"
