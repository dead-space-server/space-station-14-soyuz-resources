...
ent-RandomHumanoidSpawnerCentcomOfficial = Представитель ГШ
    .desc = { "" }
    .suffix = Призрачная роль, 210 часов общего времени
ent-RandomHumanoidSpawnerCentcomAdministrator = Администратор ГШ
    .desc = { "" }
    .suffix = АГШ
ent-RandomHumanoidSpawnerCentcomOperator = Оператор ГШ
    .desc = { "" }
    .suffix = ОГШ
ent-RandomHumanoidSpawnerCentcomSpecialOperationsOfficer = Генерал Специальных Операций
    .desc = { "" }
    .suffix = ГСО
ent-RandomHumanoidSpawnerCentcomOfficer = Офицер ГШ
    .desc = { "" }
    .suffix = { "" }
