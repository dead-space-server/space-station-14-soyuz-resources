...
ent-CrateEngineeringElectricalSupplies = ящик электромонтажного снаряжения
    .desc = СССП не несёт ответственности за любые рабочие конфликты, связанные с изолированными перчатками, входящими в комплект этих ящиков.
...
ent-CrateEngineeringVoidJetpack = ящик пустотных джетпаков
    .desc = Два джетпака для тех, кто не умеет пользоваться огнетушителями.
ent-ADTCargoUtilisatorComplectCrate = комплект снаряжения утилизатора
    .desc = Содержит в себе базовые скафандр и прочие вещи, без которых не обойтись вашему новому утилизатору (пришедшему взамен съеденного карпами прошлому)
