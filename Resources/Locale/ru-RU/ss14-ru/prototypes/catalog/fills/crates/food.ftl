...
ent-CrateFoodSoftdrinksLarge = оптовый ящик газировки
    .desc = Большое количество банок газировки, извлечённых прямо из торгоматов ГенШтаба, ведь вы просто не можете покинуть свой отдел. Включает 28 банок газировки.
