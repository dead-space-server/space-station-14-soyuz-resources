ent-CrateFunPlushie = ящик плюшевых игрушек
    .desc = Куча мягких плюшевых игрушек. Разложите их повсюду, а потом подумайте, как вы объясните эту покупку генеральному штабу.
ent-CrateFunLizardPlushieBulk = оптовый ящик плюшевых унатхов
    .desc = Куча мягких плюшевых унатхов. Разложите их повсюду, а потом подумайте, как вы объясните эту покупку генеральному штабу.
...
ent-CrateFunInstrumentsSpecial = набор специальных коллекционных инструментов
    .desc = Поднимите шум при помощи этой специальной коллекции почти-инструментов! Генеральный штаб не несёт ответственности за любые травмы, вызванные содержимым ящика.
...
ent-CrateFunBikeHornImplants = ящик хонк-имплантов
    .desc = Тысяча гудков за день отпугнёт милицию на день!
