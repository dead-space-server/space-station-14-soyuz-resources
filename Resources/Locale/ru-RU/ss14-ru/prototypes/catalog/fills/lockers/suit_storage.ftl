...
ent-SuitStorageSeniorSalvageSpecialistFilled = { ent-SuitStorageBase }
    .suffix = Мастер-шахтёр
    .desc = { ent-SuitStorageBase.desc }
ent-SuitStorageSyndie = { ent-SuitStorageBase }
    .suffix = Скафандр Рассвета, Синдикат
    .desc = { ent-SuitStorageBase.desc }
